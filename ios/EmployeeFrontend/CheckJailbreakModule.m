...
#import "CheckJailbreakModule.h"
#import <dlfcn.h>
#import <mach-o/dyld.h>
#import <TargetConditionals.h>

@implementation CheckJailbreakModule
...
#pragma mark - REACT NATIVE modules
- (BOOL)isJailBroken {
  return isSecurityCheckNotPassed();
}

- (NSDictionary *)constantsToExport
{
  return @{@"isJailBroken": @(self.isJailBroken)};
}
@end
